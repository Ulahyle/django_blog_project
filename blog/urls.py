...
urlpatterns = [
    ...
    path('cookie_session_handling/', get_theme_cookie, name="cookie_session_handling"),
    path("delete_theme_cookie/", delete_theme_cookie, name="delete_theme_cookie"),

    # Sessions
    path("track_viewed_posts/", track_viewed_posts, name="track_viewed_posts"),
    ...
    path("track_keywords/", track_keywords, name="track_keywords"),
